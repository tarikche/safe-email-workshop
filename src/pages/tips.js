  ...
  return (
    <div className='items-center justify-center'>
      <div className="flex items-center justify-center min-h-screen">
        ...
        <Image className='items-center justify-center' src="/1.png" alt="Description de l'image" width={900} height={300} />
      ...
      <div className="flex items-center justify-center min-h-screen">
        ...
        <Image className='items-center justify-center' src="/2.png" alt="Description de l'image" width={900} height={300} />
        {/* Ajoute ici le contenu de la page des conseils */}
      </div>
      <div className="flex items-center justify-center min-h-screen">
        <h1 className="text-3xl font-bold"></h1>
        ...
        <Image className='items-center justify-center' src="/3.png" alt="Description de l'image" width={900} height={300} />
        {/* Ajoute ici le contenu de la page des conseils */}
      </div>
      <div className="flex items-center justify-center min-h-screen">
        <h1 className="text-3xl font-bold"></h1>
        ...
        <Image className='items-center justify-center' src="/4.png" alt="Description de l'image" width={900} height={300} />
        {/* Ajoute ici le contenu de la page des conseils */}
      </div>
      <div className="flex items-center justify-center min-h-screen">
        <h1 className="text-3xl font-bold"></h1>
        ...
        <Image className='items-center justify-center' src="/5.png" alt="Description de l'image" width={900} height={300} />
        {/* Ajoute ici le contenu de la page des conseils */}
      </div>
      <div className="flex items-center justify-center min-h-screen">
        <h1 className="text-3xl font-bold"></h1>
        <h2>6/ Testez vos connaissances : Petit quizz interactif</h2>
        <Image className='items-center justify-center' src="/6.png" alt="Description de l'image" width={900} height={300} />
        <p>
